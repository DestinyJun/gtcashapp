...
export default class PickerExm extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const dropdown_6_icon = this.state.dropdown_6_icon_heart ? require('../../assets/images/01.jpg') : require('../../assets/images/01.jpg');
    return (
  ...
  _dropdown_2_renderRow(rowData, rowID, highlighted) {
    let icon = highlighted ? require('../../assets/images/01.jpg') : require('../../assets/images/01.jpg');
    let evenRow = rowID % 2;
    return (
